...
class FullscreenCanvas {
    ...
    renderIntoView(target = document.getElementById("tech-head")) {
        const { canvas } = this;
        ...
        canvas.className = 'tech-head-inside';
...
const shape = {
    ...
    init(container = document.getElementById("tech-head")) {
        if (this.isAlive) {
            return;
        }

  ...
  return (
    <div className="pt-24">
      ...
      <div className="text-white px-32">
        ...
        <p className="font-bold text-2xl py-5">Log Data</p>
        ...
        <p className="font-bold text-2xl py-5">Cookies</p>
        ...
        <p className="font-bold text-2xl py-5">Service Providers</p>
        ...
        <p className="font-bold text-2xl py-5">Security</p>
        ...
        <p className="font-bold text-2xl py-5">Links to Other Sites</p>
        ...
        <p className="font-bold text-2xl py-5">Children's Privacy</p>
